...
function ComplaintType() {
	...
	return (
		<div className="usa-app">
			...
			<main
				id="main-content"
				className="usa-section padding-y-4"
			>
				<GridContainer>
					<Grid row>
						<Grid col={12}>
							<p className="text-right font-sans-3xs text-base-dark">
							...
							<Grid row>
								...
								>
									<div className="usa-prose">
										<h1 className="font-heading-lg margin-top-0 margin-bottom-1">
											Complaint Type
										</h1>
										<h2 className="font-heading-sm margin-top-0 margin-bottom-4 text-base-dark font-weight-normal">
											...
											>
												...
												<div className="usa-radio usa-radio--tile margin-bottom-3 border-1px border-base-lighter">
													...
													<p className="margin-left-4 margin-top-1 font-sans-sm text-base-dark margin-bottom-0">
														Select if a covered entity is in violation
														of the following transactions: claims and
														encounter information, payment and
														remittance advice, claims status,
														eligibility, enrollment and disenrollment,
														referrals and authorizations, coordination
												...
												<div className="usa-radio usa-radio--tile margin-bottom-3 border-1px border-base-lighter">
													...
													<p className="margin-left-4 margin-top-1 font-sans-sm text-base-dark margin-bottom-0">
														Select if a covered entity is in violation
														of the following Code Sets: HCPCS (Ancillary
														Services/Procedures), CPT-4 (Physicians
														Procedures), CDT (Dental Terminology), ICD-9
														(Diagnosis and Hospital Inpatient
														Procedures), ICD-10 (As of October 1, 2015)
														and NDC (National Drug Codes) codes with
														which providers and health plan are
														familiar, are the adopted code sets for
														procedures, diagnoses, and drugs.
													</p>
												</div>
												...
												<div className="usa-radio usa-radio--tile margin-bottom-3 border-1px border-base-lighter">
													<Radio
														...
														onChange={handleRadioChange}
														checked={
															selectedType === 'uniqueIdentifiers'
														}
														tile
													/>
													<p className="margin-left-4 margin-top-1 font-sans-sm text-base-dark margin-bottom-0">
														Select if a covered entity is in violation
														of the following Unique Identifiers:
														National Provider Identifier (NPI), Employer
												...
												<div className="usa-radio usa-radio--tile margin-bottom-3 border-1px border-base-lighter">
													...
													/>
													<p className="margin-left-4 margin-top-1 font-sans-sm text-base-dark margin-bottom-0">
														Select if a covered entity is suspected of
														being in violation of any of the adopted
														Operating Rules: Electronic Funds
														Transfer/Electronic Remittance Advice
														(EFT/ERA), Health Care Claim Status, and
							...
							>
								...
								>
									...
									<Button
										...
										onClick={handleComplainantDetailsClick}
									>
						...
						<div className="usa-footer__logo grid-row mobile-lg:grid-col-6 mobile-lg:grid-gap-2">
							...
							<div className="mobile-lg:grid-col-auto">
								<h3 className="usa-footer__logo-heading">
									Administrative Simplification Enforcement Testing Tool (ASETT)
								</h3>
							</div>
						</div>
